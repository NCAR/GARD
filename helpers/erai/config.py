...
def parse():
    parser= argparse.ArgumentParser(description='Convert ERAi files to GARD input files')
    ...
    parser.add_argument('atmdir',       nargs="?",  action='store',  help="ERAi atmospheric data file location",default="ei.oper.an.pl/_Y__M_/")
    parser.add_argument('sfcdir',       nargs="?",  action='store',  help="ERAi surface data file location",    default="ei.oper.fc.sfc/_Y__M_/")
    parser.add_argument('atmfile',      nargs="?",  action='store',  help="ERAi primary atmospheric file",      default="ei.oper.an.pl.regn128sc._Y__M__D__h_")
    parser.add_argument('atmuvfile',    nargs="?",  action='store',  help="ERAi U/V atm file",                  default="ei.oper.an.pl.regn128uv._Y__M__D__h_")
    ...
    parser.add_argument('-d', '--daily',            action='store_true', help="convert files to monthly files with daily timestep", default=False, dest='daily')

    parser.add_argument('-v', '--version',action='version',
            version='ERAi2GARD v'+version)
